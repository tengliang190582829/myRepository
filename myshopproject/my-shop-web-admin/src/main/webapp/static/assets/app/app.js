var App = function (){
    ...
    var handlerInitCheckBox = function() {
        ...
        //表头主check
        var _icheck_master =  $('input[type="checkbox"].minimal-red.icheck_master');
        // 全部check
        var _minimal_red =  $('input[type="checkbox"].minimal-red ');
        _icheck_master.on('ifClicked', function (e) {
            if(e.target.checked)
            {
